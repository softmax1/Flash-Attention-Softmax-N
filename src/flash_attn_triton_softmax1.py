# [2023-08-07] Downloaded from https://github.com/Dao-AILab/flash-attention/blob/main/flash_attn/flash_attn_triton_og.py
# Changed marked by "modified by CWM"
...
def _fwd_kernel(
    ...
    out_ptrs = Out + off_o
    tl.store(out_ptrs, acc * l_i / (l_i + tl.exp(-m_i)))  # *** modified by CWM ***
